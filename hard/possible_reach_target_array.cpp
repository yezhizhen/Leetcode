//https://leetcode.com/problems/construct-target-array-with-multiple-sums/discuss/2189625/C%2B%2B-oror-100-memory-oror-Commented
class Solution {
public:
    bool isPossible(vector<int>& target) {
        ...
        auto q = priority_queue(less<int>(), move(target)); // O(n) time. target is destroyed by move constructor 
